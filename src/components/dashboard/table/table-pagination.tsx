...
export function TablePagination<TData>({ table,pagination }: TablePaginationProps<TData>) {
  ...
  return (
    <div className='mx-auto mt-4 flex flex-col items-center justify-between gap-2 lg:flex-row'>
      ...
      <div className='flex flex-col items-center space-y-3 lg:flex-row lg:space-x-8 lg:space-y-0'>
        <div className='my-2 items-center space-x-2 space-y-2 lg:my-0 lg:flex lg:space-y-0'>
          ...
          >
            <SelectTrigger className='mx-auto h-8 w-[90px] bg-background'>
